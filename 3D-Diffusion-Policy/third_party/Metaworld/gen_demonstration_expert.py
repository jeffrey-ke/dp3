...
def main(args):
    ...
    while episode_idx < num_episodes:
        ...
        while not done:
            ...
            obs_img_high_res = obs_dict['image_high_res']
            ...
            img_arrays_high_def_sub.append(obs_img_high_res)
        ...
        if not ep_success or ep_success_times < 5:
            ...
            img_arrays_high_def.extend(copy.deepcopy(img_arrays_high_def_sub))
    ...
    img_chunk_size_high_def = (100, img_arrays_high_def.shape[1], img_arrays_high_def.shape[2], img_arrays_high_def.shape[3])
    ...
    zarr_data.create_dataset('img_high_def', data=img_arrays_high_def, chunks=img_chunk_size_high_def, dtype='uint8', overwrite=True, compressor=compressor)
    ...
    cprint(f'img_high_def shape: {img_arrays_high_def.shape}, range: [{np.min(img_arrays_high_def)}, {np.max(img_arrays_high_def)}]', 'green')
